...
"""Implement a get_hyper method with two integer arguments: index with a
...
If the user queries index 0, page_size 10, the first return index should be 0
-9 included.
If the user queries index 10, page_size 10, but rows 3, 6, and 7 were removed
the user should stille receive rows indexed 10 to 19 included."""
...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """Deletion-resilient hypermedia paginnation occuring
        """
