...
### [2. Basic test using Chai assertion library](./2-read_file.js)
...
#### Files: [6-payment_token.js](./6-payment_token.js), [5-payment.test.js](./6-payment_token.test.js)


### [7. Skip](./7-http_express.js)
...
### - Files: [8-api/package.json](./8-api/package.json), [8-api/api.js](./8-api/api.js), [8-api/api.test.js](./8-api/api.test.js)
...
#### - Files: [9-api/package.json](./9-api/package.json), [9-api/api.js](./9-api/api.js), [9-api/api.test.js](./9-api/api.test.js)
...
#### - Files: [10-api/package.json](./10-api/package.json), [10-api/api.js](./10-api/api.js), [10-api/api.test.js](./10-api/api.test.js)
